...
- ** Persistent Countdown Service:** A live, persistent background notification on Android showing the countdown to the next prayer, seamlessly transitioning between days.
...
├── assets/                        #  Images, icons, audio effects, and compass SVGs
├── lib/
...
---
**Made with 🩵 using Flutter & Kotlin.**
